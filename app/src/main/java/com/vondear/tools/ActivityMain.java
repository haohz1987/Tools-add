...
import com.vondear.tools.activity.ActivityAutoImageView;
import com.vondear.tools.activity.ActivityCardStack;
import com.vondear.tools.activity.ActivityCobweb;
import com.vondear.tools.activity.ActivityContact;
import com.vondear.tools.activity.ActivityCreateQRCode;
import com.vondear.tools.activity.ActivityDeviceInfo;
import com.vondear.tools.activity.ActivityDialog;
import com.vondear.tools.activity.ActivityLike;
import com.vondear.tools.activity.ActivityLoading;
import com.vondear.tools.activity.ActivityLocation;
import com.vondear.tools.activity.ActivityLoginAct;
import com.vondear.tools.activity.ActivityNetSpeed;
import com.vondear.tools.activity.ActivityPopupView;
import com.vondear.tools.activity.ActivityProgressBar;
import com.vondear.tools.activity.ActivityRunTextView;
import com.vondear.tools.activity.ActivityRxCaptcha;
import com.vondear.tools.activity.ActivityRxDataTool;
import com.vondear.tools.activity.ActivityRxExifTool;
import com.vondear.tools.activity.ActivityRxPhoto;
import com.vondear.tools.activity.ActivityRxRotateBar;
import com.vondear.tools.activity.ActivityRxScaleImageView;
import com.vondear.tools.activity.ActivityRxToast;
import com.vondear.tools.activity.ActivitySeat;
import com.vondear.tools.activity.ActivitySeekBar;
import com.vondear.tools.activity.ActivityShoppingView;
import com.vondear.tools.activity.ActivitySlidingDrawerSingle;
import com.vondear.tools.activity.ActivitySplash;
import com.vondear.tools.activity.ActivityTextTool;
import com.vondear.tools.activity.ActivityVibrate;
import com.vondear.tools.activity.ActivityWheelHorizontal;
import com.vondear.tools.activity.ActivityZipEncrypt;
import com.vondear.tools.adapter.AdapterRecyclerViewMain;
import com.vondear.tools.algorithm.encryption.ActEncryp;
import com.vondear.tools.bean.ModelMainItem;
import com.vondear.tools.metro.ActWin10Metro;
import com.vondear.tools.metro.ActXmlToBitmap;
...
public class ActivityMain extends AppCompatActivity {
    ...
    private void initData() {
        ...
        //新增
        mData.add(new ModelMainItem("数据加解密",R.drawable.encryp,ActEncryp.class));
        mData.add(new ModelMainItem("win10_metro样式",R.drawable.win8_metro,ActWin10Metro.class));
//        mData.add(new ModelMainItem("win8_drag图片拖动替换",R.drawable.win8_metro,ActXmlToBitmap.class));
        mData.add(new ModelMainItem("xml转bitmap",R.drawable.xmltobitmap,ActXmlToBitmap.class));
