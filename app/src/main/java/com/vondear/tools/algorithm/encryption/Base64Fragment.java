package com.vondear.tools.algorithm.encryption;
...
import com.vondear.tools.algorithm.Base64_;
...
public class Base64Fragment extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        ((ActEncryp) activity).onSectionAttached(
    ...
    private class myClickListener implements View.OnClickListener {
        ...
        public void onClick(View view){
            if (view == buttonJiami){
                ...
                String miwen = "";
                try {
                     miwen= Base64_.encryptBASE64(mingData);
                }catch (Exception e){
                    e.printStackTrace();
                }
                ...
                byte[] mingData = null;
                try {
                     mingData = Base64_.decryptBASE64(miwen);
                }catch (Exception e){
                    e.printStackTrace();
                }
