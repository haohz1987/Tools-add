...
public class Win10Layout extends RelativeLayout {

	private MetroLayout mMl;

	public Win10Layout(Context context) {
		super(context);
		init();
	}

	public Win10Layout(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public Win10Layout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	...
	private void init() {
		setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				{
					AnimationsUtils.startScaleUp(Win10Layout.this, 100);
				}
				return true;
			}
		});
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			startX = event.getX();
			startY = event.getY();
			AnimationsUtils.startScaleDown(Win10Layout.this);
